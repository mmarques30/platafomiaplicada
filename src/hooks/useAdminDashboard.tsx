...
export function useAdminDashboard() {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      // Buscar total de usuários distintos da Mari (count separado)
      const { count: totalUsuariosMari } = await supabase
        .from("chat_messages")
      ...
      const usuariosUsandoMari = totalUsuariosMari || new Set(chatData.map(m => m.user_id)).size;
