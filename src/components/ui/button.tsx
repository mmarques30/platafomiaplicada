...
/**
 * Botões no padrão de iaplicada.com: sempre pílula. A ação principal é o
 * lime com brilho (`.cta-lime`), a secundária é vazada sobre a superfície.
 * `brand-pill` e `brand-pill-outline` são aliases mantidos por
