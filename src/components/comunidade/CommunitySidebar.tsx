...
import { Users, UserCog, Circle } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          <CardTitle className="text-base">IAplicada Community</CardTitle>
        </CardHeader>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          <CardTitle className="text-base">Top 3 (30 dias)</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          {top3.map((member, index) => (
            <div key={member.user_id} className="flex items-center gap-3">
              <div className="text-lg font-bold text-zinc-500 w-6">
                {index + 1}
              </div>
