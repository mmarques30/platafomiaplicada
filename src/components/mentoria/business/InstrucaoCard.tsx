              ...
              <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
                ...
                <CollapsibleContent className="mt-3 space-y-4">
                  ...
                  {instrucao.prompt_sugerido && (
                    <div className="bg-status-info/15 dark:bg-status-info/40 border border-status-info/40 dark:border-status-info rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Bot className="h-4 w-4 text-status-info dark:text-status-info" />
                        <span className="text-xs font-semibold text-status-info dark:text-status-info uppercase tracking-wide">
                          Prompt Sugerido
                        </span>
                      </div>
                      <div className="text-sm text-status-info dark:text-status-info/40 prose prose-sm dark:prose-invert max-w-none">
                        <ReactMarkdown remarkPlugins={[remarkGfm]} components={markdownComponents}>
                          {instrucao.prompt_sugerido}
                        </ReactMarkdown>
                      </div>
                  ...
                  {/* Dicas */}
                  {instrucao.dicas && (
                    <div className="bg-status-warning/15 dark:bg-status-warning/40 border border-status-warning/40 dark:border-status-warning rounded-lg p-4">
                      <div className="flex items-start gap-2">
                        <Lightbulb className="h-4 w-4 text-status-warning dark:text-status-warning mt-0.5 shrink-0" />
                        <div className="flex-1">
                          <span className="text-xs font-semibold text-status-warning dark:text-status-warning uppercase tracking-wide block mb-1">
                            Dicas
                          </span>
                          <div className="text-sm text-status-warning dark:text-status-warning/40 prose prose-sm dark:prose-invert max-w-none">
                            <ReactMarkdown remarkPlugins={[remarkGfm]} components={markdownComponents}>
                              {instrucao.dicas}
                            </ReactMarkdown>
                          </div>
