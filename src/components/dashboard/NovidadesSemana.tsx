...
export function NovidadesSemana() {
  ...
  return (
    <Card className="card-micro-hover relative overflow-hidden card-primary p-3 sm:p-4 md:p-8 lg:p-12 border border-primary/20 sm:border-2 shadow-lg sm:shadow-xl">
