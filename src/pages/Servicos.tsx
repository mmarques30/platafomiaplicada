        ...
        <ExampleContent>
          ...
          <div className="col-span-1 md:col-span-8 mt-8">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 px-5 py-2.5 bg-background border border-[#2a2c29] text-primary font-medium rounded-sm hover:border-primary transition-all duration-300 uppercase tracking-wider text-xs"
            >
