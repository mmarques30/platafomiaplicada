  ...
  return (
    <Tabs defaultValue="indicadores" className="space-y-6">
      <TabsList className="bg-white border border-gray-200 rounded-lg p-1 w-full grid grid-cols-6 gap-1">
        ...
        <TabsTrigger value="equipe" className="text-xs md:text-sm">Equipe</TabsTrigger>
        <TabsTrigger value="entregas" className="text-xs md:text-sm">Entregas</TabsTrigger>
        <TabsTrigger value="cronograma" className="text-xs md:text-sm">Cronograma</TabsTrigger>
        <TabsTrigger value="alertas" className="text-xs md:text-sm">Alertas</TabsTrigger>
        <TabsTrigger value="impacto" className="text-xs md:text-sm">Impacto</TabsTrigger>
      </TabsList>

      {/* INDICADORES */}
      <TabsContent value="indicadores" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Indicadores Gerais</h2>
          <p className="text-gray-600">Visao consolidada do programa</p>
        </div>
      ...
      <TabsContent value="equipe" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Equipe</h2>
          <p className="text-gray-600">Acompanhamento individual</p>
        </div>
      ...
      <TabsContent value="entregas" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Entregas</h2>
          <p className="text-gray-600">Status dos projetos da equipe</p>
        </div>
      ...
      <TabsContent value="cronograma" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          ...
          <p className="text-gray-600">Progresso nas 12 semanas</p>
        </div>
      ...
      <TabsContent value="alertas" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Atencao Necessaria</h2>
          <p className="text-gray-600">Itens que precisam de acompanhamento</p>
        </div>
        ...
        {alertas.length > 0 ? (
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-green-800">Tudo em dia! Nenhum alerta no momento.</p>
            </div>
          </div>
        )}
      </TabsContent>
      ...
      <TabsContent value="impacto" className="space-y-6">
        <div className="border-l-4 pl-4" style={{ borderColor: brandGreen }}>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Impacto Acumulado</h2>
          <p className="text-gray-600">Resultados desde o inicio do programa</p>
        </div>

        <div className="bg-white p-6 rounded-lg border-2" style={{ borderColor: brandGreen }}>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <p className="text-3xl font-bold" style={{ color: brandGreen }}>31h</p>
              <p className="text-sm text-gray-600">economizadas/semana</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold" style={{ color: brandGreen }}>4</p>
              <p className="text-sm text-gray-600">entregas em producao</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold" style={{ color: brandGreen }}>186h</p>
              <p className="text-sm text-gray-600">total economizado (6 sem)</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold" style={{ color: brandGreen }}>R$ 11.160</p>
              <p className="text-sm text-gray-600">valor gerado (R$60/h)</p>
            </div>
          </div>

          <div className="mt-6 pt-6 border-t border-gray-200 flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Investimento no programa</p>
              <p className="font-bold text-gray-900">R$ 4.497</p>
            </div>
            <div className="text-right">
              <p className="text-sm text-gray-600">ROI atual</p>
              <p className="font-bold text-2xl" style={{ color: brandGreen }}>148%</p>
            </div>
          </div>
        </div>
