...
import { ArrowLeft, Users, FileText, Calendar, FolderKanban, Route, Plus, ClipboardList, Sparkles, FolderOpen, Trash2, Monitor, Video } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function MentoriaBusinessIAplicadaPage() {
  ...
  const users = allUsers.filter(u => u.plano_mentoria === "insider_business");
