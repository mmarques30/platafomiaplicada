...
export default function MentoriaBusinessPage() {
  ...
  const users = allUsers.filter(u => u.plano_mentoria === "business_parceria" || u.plano_mentoria === "business" || (Array.isArray(u.roles) && u.roles.includes("parceiros")));
      ...
      {selectedUserId && (
        <Tabs defaultValue="diagnostico" className="space-y-4">
          <TabsList className="flex-wrap">
            ...
            <TabsTrigger value="instrucoes" className="text-xs gap-1.5">
