...
export default function PoliticaVendas() {
  ...
  const { data: documento, isLoading } = useDocumentoLegal("politica-vendas");

  // Redireciona visitante para configurações
  useEffect(() => {
    if (!isLoadingRole && isVisitante) {
      navigate("/configuracoes", { replace: true });
    }
  }, [isVisitante, isLoadingRole, navigate]);
