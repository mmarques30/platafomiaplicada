    ...
    <div className="min-h-screen bg-background">
      <main className="container py-6 md:py-8 px-4 md:px-6 space-y-6">
        ...
        <Tabs defaultValue="calendario" className="w-full">
          <TabsList className="w-full md:w-auto grid grid-cols-2 md:inline-flex gap-0.5 sm:gap-1 bg-aplicada-green-900/40 p-1 sm:p-1.5 rounded-lg sm:rounded-xl border border-aplicada-green-700/30">
            <TabsTrigger 
              value="calendario" 
